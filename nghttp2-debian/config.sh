...
NGHTTP2_BUILD_PACKAGES="$NGHTTP2_DOWNLOAD_PACKAGES g++ make binutils autoconf automake autotools-dev libtool pkg-config zlib1g-dev libssl-dev libxml2-dev libev-dev libevent-dev libjemalloc-dev libjansson-dev libc-ares-dev python"
