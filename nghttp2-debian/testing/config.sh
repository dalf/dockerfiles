...
#   cython python-dev python-setuptools - python bindings
NGHTTP2_BUILD_PACKAGES="$NGHTTP2_DOWNLOAD_PACKAGES g++ make binutils autoconf automake autotools-dev libtool pkg-config zlib1g-dev libssl-dev libxml2-dev libev-dev libevent-dev libjemalloc-dev libjansson-dev libc-ares-dev python3-dev cython3 python3-setuptools"

## Run time dependencies ##
# openssl binary is needed for OCSP /usr/share/nghttp2/fetch-ocsp-response
NGHTTP2_RUN_PACKAGES="openssl libev4 libevent-2.1-6 libevent-openssl-2.1-6 libjemalloc1 libxml2 libjansson4 zlib1g openssl xml-core ca-certificates python3 libc-ares2"
