...
# Core list from docs
NGHTTP2_BUILD_PACKAGES="$NGHTTP2_DOWNLOAD_PACKAGES make binutils autoconf automake autotools-dev libtool pkg-config zlib1g-dev libssl-dev libxml2-dev libev-dev libevent-dev libjemalloc-dev libjansson-dev python"

# Spdylay
NGHTTP2_BUILD_PACKAGES="$NGHTTP2_BUILD_PACKAGES autoconf automake autotools-dev libtool pkg-config zlib1g-dev libcunit1-dev libssl-dev libxml2-dev libevent-dev"
...
NGHTTP2_RUN_PACKAGES="libev4 libevent-2.0-5 libevent-openssl-2.0-5 libjemalloc1 libxml2 libjansson4 zlib1g openssl xml-core ca-certificates python"
